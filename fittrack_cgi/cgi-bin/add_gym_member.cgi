...
# -*- coding: utf-8 -*-
"""
CGI Script to add a gym member
"""
...
def add_gym_member(form_data):
    ...
    try:
        ...
        end_date = form_data.getvalue('end_date', None)
        gym_id = form_data.getvalue('gym_id', '')
        
        # Validate required fields
        if not all([user_id, membership_id, membership_type, start_date, gym_id]):
        ...
        sql = """
            ...
            VALUES (%s, %s, %s, %s, %s, %s)
        """
        cursor.execute(sql, (user_id, membership_id, membership_type, start_date, end_date if end_date else None, gym_id))
        conn.commit()
        ...
        return True, result_id, "Gym Member added"
...
def main():
    ...
    success, result_id, message = add_gym_member(form)
        ...
        print(f"""
            <section class="feedback-section">
                <div class="success-message">
                    <h1>✅ Gym Member Added Successfully!</h1>
                    <div class="feedback-details">
                        ...
                        <p><strong>Membership Type:</strong> {form.getvalue("membership_type", "N/A")}</p>
                    </div>
                    <div class="feedback-actions">
                        <a href="/~azinovev/forms/add_gym_member.html" class="btn-primary">Add Another Gym Member</a>
