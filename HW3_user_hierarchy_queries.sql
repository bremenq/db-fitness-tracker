-- HW3: User Hierarchy Queries

-- Query 1: Show user types and their workout activity
SELECT 
    CASE 
...
-- Query 2: Find gym members with good progress
SELECT 
    g.name AS gym_name,
...
-- Query 3: Compare workout duration by user type
SELECT 
    CASE 
        WHEN iu.user_id IS NOT NULL THEN 'Individual User'
        WHEN gm.user_id IS NOT NULL THEN 'Gym Member'  
